...
public class TaskView extends FrameLayout implements Reusable {
    ...
    protected void updateSnapshotRadius() {
        updateCurrentFullscreenParams(false /* split screen */);
        mSnapshotView.setFullscreenParams(mCurrentFullscreenParams);
    }

    void updateCurrentFullscreenParams(boolean isSplitScreen) {
        updateFullscreenParams(mCurrentFullscreenParams, isSplitScreen);
    }
